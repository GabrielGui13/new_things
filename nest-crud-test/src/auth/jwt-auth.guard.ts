...
@Injectable()
export class JwtAuthGuard extends AuthGuard('jwt') {} //por ter colocado o 'local', o passport sabe que deve ir no local.strategy e rodar, e ao rodar, chama o validate
